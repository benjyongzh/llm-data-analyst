...
- Chart recommendations are generated by an LLM from each task's description, returning only chart type names drawn from client-provided `available_charts`
